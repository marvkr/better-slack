...
function AppShellContent({
  ...
  const submittedStatusCounts = useAtomValue(submittedTaskStatusCountsAtom)
  ...
  const listTitle = React.useMemo(() => {
    ...
    if (isConductorNavigation(navState)) {
      ...
      return titles[navState.filter.kind] ?? 'Tasks'
    }
  ...
  return (
    <AppShellProvider value={appShellContextValue}>
      ...
      <div className="h-full flex items-stretch relative">
        ...
        >
          {/* Conductor: 2-column layout replaces navigator + resize handle + main panel */}
